...
- [] Kehityksen aikainen ajoympäristö 
    ...
    - Edellinen komento ei kuitenkaan ole paras vaihtoehto, koska springiiä ei voi helposti sammuttaa ilman että koko kontti sammuu, ja uudelleenkäynnistys vaatii uuden kontin ja kirjastoriippuvuuksien uudelleenlatauksen, parempi on käynnistää interaktiivinen terminaali seuraavasti: `docker run -it -p 8080:8080 -v ${PWD}/spring-hello/hello:/app -w /app eclipse-temurin:17-jdk bash` ja käynnistää spring erikseen terminaalista.
